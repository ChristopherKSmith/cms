...
if(isset($_POST['update_post'])){
   ...
   $update_post= mysqli_query($connection, $query);
    ...
    echo "<h2 class = 'bg-success'>Post Updated. <a href = '../post.php?p_id={$the_post_id}'>View Post</a> or <a href = 'posts.php'>Edit Other Posts</a></h2>";
    }
?>  
...
<form action ="" method ="post" enctype="multipart/form-data">
   ...
   <div class = "form-group">
       <label for = "title">Edit Post Author</label>
